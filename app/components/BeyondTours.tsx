  ...
  const services = [
    {
      ...
      title: t.beyond.transferTitle,
      desc: t.beyond.transferDesc,
      cta: t.beyond.transferCta,
      href: "/transfers",
    },
    {
      icon: (
      ...
      title: t.beyond.skipperTitle,
      desc: t.beyond.skipperDesc,
      cta: t.beyond.skipperCta,
