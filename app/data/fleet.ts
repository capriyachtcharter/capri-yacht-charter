...
export const fleet: Boat[] = [
  ...
  },
  {
    ...
    gallery: [
      "/fleet/tramontana/action.jpg",     // cover · exterior · side action past the coast
      "/fleet/tramontana/bow-action.jpg", // exterior · bow-on through spray with Sorrento villa
